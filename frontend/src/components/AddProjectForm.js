...
//   const isEditing = onAddProject?.isEditing || false;
//   const existingData = onAddProject?.projectData || {};

//   const [projectName, setProjectName] = useState(existingData.name || "");
//   const [projectUrl, setProjectUrl] = useState(existingData.url || "");
//   const [preprodUrl, setPreprodUrl] = useState(existingData.preprodUrl || "");
//   const [prodUrl, setProdUrl] = useState(existingData.prodUrl || "");
//   const [pgUrl, setPgUrl] = useState(existingData.pgUrl || "");
...
//     try {
//       const url = isEditing
//         ? `${BASE_API}/projects/update/${existingData.uuid}`
//         : `${BASE_API}/projects/add`;
...
//       } else {
//         setMessage(data.detail || "Failed to save project.");
//       }
//     } catch {
//       setMessage("Error processing request. Try again.");
//     }
//   };
...
//         <button onClick={handleSubmit} className="w-full p-2 mt-4 bg-blue-500 text-white rounded hover:bg-blue-600">{isEditing ? "Update Project" : "Add Project"}</button>
